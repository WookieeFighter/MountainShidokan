...
<head>
	...
	<title>Mountain Shidokan Karate</title>
...
<body>
	...
	<section class="tradition-header">
		<h1>Events At Mountain Shidokan Karate</h1>
		<h2></h2>
	</section>
	<div class="events events-background">
		<div class="container">
			<iframe src="http://www.mountainshidokan.net/wordpress/index.php" width="100%" height="1600" border="0"></iframe>
		</div>
	</div>

	<footer>
		<div class="container">
			<p>Mountain Shidokan Karate  || 289-244-3104  || info@mountainshidokan.com</p>
		</div>
	</footer>
</body>
</html>
